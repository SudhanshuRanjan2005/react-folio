      ...
      <div className='row'>
        ...
        <div className='col-lg-8 about-right'>
          <p className='about-intro'>
            Hi there! I am Sudhanshu. Tech enthusiast, Open source code believer
            and self-taught React Web Developer.
          </p>
          <p className='about-intro'>
            Currently I am pursuing my class '10' from KVs. Being a Tech
            Enthusiast from my childhood. I love to build stuffs. I love to do
            photography 📷, editing, playing badmintion🏸, and much
            more...😊😊😊
          </p>
          <p className='ps'>
          ...
          <div className='skills'>
            <p className='skills-about'>Some of my skills are:</p>
